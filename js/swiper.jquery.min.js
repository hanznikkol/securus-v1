            ...
            function l(e) {
                ...
                if (
                    ...
                    x.isHorizontal()
                        ...
                        : ((38 !== a && 40 !== a) || (e.preventDefault ? e.preventDefault() : (e.returnValue = !1)), 40 === a && x.slideNext(), 38 === a && x.slidePrev()),
            ...
            if (
                ...
                (x.container[0].swiper = x),
                    ...
                    ("fade" !== x.params.effect && "flip" !== x.params.effect) ||
                        ((x.params.slidesPerView = 1), (x.params.slidesPerColumn = 1), (x.params.slidesPerGroup = 1), (x.params.watchSlidesProgress = !0), (x.params.spaceBetween = 0), void 0 === g && (x.params.virtualTranslate = !0)),
                    ...
                    (x.updateSlidesSize = function () {
                        ...
                        if (void 0 !== x.size) {
                            "string" == typeof a && a.indexOf("%") >= 0 && (a = (parseFloat(a.replace("%", "")) / 100) * x.size),
                                (x.virtualSize = -a),
                                x.rtl ? x.slides.css({ marginLeft: "", marginTop: "" }) : x.slides.css({ marginRight: "", marginBottom: "" });
                            var n;
                            x.params.slidesPerColumn > 1 &&
                                ((n =
                                    Math.floor(x.slides.length / x.params.slidesPerColumn) === x.slides.length / x.params.slidesPerColumn ? x.slides.length : Math.ceil(x.slides.length / x.params.slidesPerColumn) * x.params.slidesPerColumn),
                            ...
                            for (e = 0; e < x.slides.length; e++) {
                                ...
                                if (x.params.slidesPerColumn > 1) {
                                    ...
                                    "column" === x.params.slidesPerColumnFill
                                        ...
                                        m
                                            .css("margin-" + (x.isHorizontal() ? "top" : "left"), 0 !== g && x.params.spaceBetween && x.params.spaceBetween + "px")
                                            .attr("data-swiper-column", c)
                                            .attr("data-swiper-row", g);
                                }
                                "none" !== m.css("display") &&
                                    ("auto" === x.params.slidesPerView
                                        ? ((o = x.isHorizontal() ? m.outerWidth(!0) : m.outerHeight(!0)), x.params.roundLengths && (o = r(o)))
                            ...
                            var h;
                            if (
                                (x.rtl && x.wrongRTL && ("slide" === x.params.effect || "coverflow" === x.params.effect) && x.wrapper.css({ width: x.virtualSize + x.params.spaceBetween + "px" }),
                                (x.support.flexbox && !x.params.setWrapperSize) ||
                                    (x.isHorizontal() ? x.wrapper.css({ width: x.virtualSize + x.params.spaceBetween + "px" }) : x.wrapper.css({ height: x.virtualSize + x.params.spaceBetween + "px" })),
                                x.params.slidesPerColumn > 1 &&
                            ...
                            0 === x.snapGrid.length && (x.snapGrid = [0]),
                                0 !== x.params.spaceBetween && (x.isHorizontal() ? (x.rtl ? x.slides.css({ marginLeft: a + "px" }) : x.slides.css({ marginRight: a + "px" })) : x.slides.css({ marginBottom: a + "px" })),
                    ...
                    (x.updateClasses = function () {
                        ...
                        a.addClass(x.params.slideActiveClass),
                            s.loop &&
                                (a.hasClass(x.params.slideDuplicateClass)
                                    ? x.wrapper.children("." + x.params.slideClass + ":not(." + x.params.slideDuplicateClass + ')[data-swiper-slide-index="' + x.realIndex + '"]').addClass(x.params.slideDuplicateActiveClass)
                        ...
                        if (
                            ...
                            s.loop &&
                                (t.hasClass(x.params.slideDuplicateClass)
                                    ? x.wrapper
                                          .children("." + x.params.slideClass + ":not(." + x.params.slideDuplicateClass + ')[data-swiper-slide-index="' + t.attr("data-swiper-slide-index") + '"]')
                                          .addClass(x.params.slideDuplicateNextClass)
                                    : x.wrapper.children("." + x.params.slideClass + "." + x.params.slideDuplicateClass + '[data-swiper-slide-index="' + t.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicateNextClass),
                                r.hasClass(x.params.slideDuplicateClass)
                                    ? x.wrapper
                                          .children("." + x.params.slideClass + ":not(." + x.params.slideDuplicateClass + ')[data-swiper-slide-index="' + r.attr("data-swiper-slide-index") + '"]')
                            ...
                            if (
                                ...
                                "fraction" === x.params.paginationType && (x.paginationContainer.find("." + x.params.paginationCurrentClass).text(i + 1), x.paginationContainer.find("." + x.params.paginationTotalClass).text(n)),
                        ...
                        x.params.loop ||
                            (x.params.prevButton &&
                                ...
                                (x.isBeginning
                                    ? (x.prevButton.addClass(x.params.buttonDisabledClass), x.params.a11y && x.a11y && x.a11y.disable(x.prevButton))
                                    : (x.prevButton.removeClass(x.params.buttonDisabledClass), x.params.a11y && x.a11y && x.a11y.enable(x.prevButton))),
                            x.params.nextButton &&
                                x.nextButton &&
                                x.nextButton.length > 0 &&
                                (x.isEnd
                                    ? (x.nextButton.addClass(x.params.buttonDisabledClass), x.params.a11y && x.a11y && x.a11y.disable(x.nextButton))
                                    : (x.nextButton.removeClass(x.params.buttonDisabledClass), x.params.a11y && x.a11y && x.a11y.enable(x.nextButton))));
                    }),
                        ...
                        if (x.params.pagination && x.paginationContainer && x.paginationContainer.length > 0) {
                            ...
                            if ("bullets" === x.params.paginationType) {
                                for (var a = x.params.loop ? Math.ceil((x.slides.length - 2 * x.loopedSlides) / x.params.slidesPerGroup) : x.snapGrid.length, t = 0; t < a; t++)
                                    e += x.params.paginationBulletRender
                                        ...
                                        : "<" + x.params.paginationElement + ' class="' + x.params.bulletClass + '"></' + x.params.paginationElement + ">";
                            ...
                            "fraction" === x.params.paginationType &&
                                ((e = x.params.paginationFractionRender
                                    ...
                                    : '<span class="' + x.params.paginationCurrentClass + '"></span> / <span class="' + x.params.paginationTotalClass + '"></span>'),
                                x.paginationContainer.html(e)),
                                "progress" === x.params.paginationType &&
                                    ((e = x.params.paginationProgressRender ? x.params.paginationProgressRender(x, x.params.paginationProgressbarClass) : '<span class="' + x.params.paginationProgressbarClass + '"></span>'),
                                    x.paginationContainer.html(e)),
                            ...
                            if (e) {
                                x.controller && x.controller.spline && (x.controller.spline = void 0),
                                    x.params.freeMode
                                        ...
                                        : (("auto" === x.params.slidesPerView || x.params.slidesPerView > 1) && x.isEnd && !x.params.centeredSlides ? x.slideTo(x.slides.length - 1, 0, !1, !0) : x.slideTo(x.activeIndex, 0, !1, !0)) || a();
                    ...
                    (x.onResize = function (e) {
                        ...
                        if (x.params.freeMode) {
                            ...
                            x.updateClasses(), (s = ("auto" === x.params.slidesPerView || x.params.slidesPerView > 1) && x.isEnd && !x.params.centeredSlides ? x.slideTo(x.slides.length - 1, 0, !1, !0) : x.slideTo(x.activeIndex, 0, !1, !0));
                    ...
                    window.navigator.pointerEnabled
                        ...
                        : window.navigator.msPointerEnabled && (x.touchEventsDesktop = { start: "MSPointerDown", move: "MSPointerMove", end: "MSPointerUp" }),
                    (x.touchEvents = {
                    ...
                    (x.initEvents = function (e) {
                        ...
                        if (x.browser.ie) r[t](x.touchEvents.start, x.onTouchStart, !1), i[t](x.touchEvents.move, x.onTouchMove, n), i[t](x.touchEvents.end, x.onTouchEnd, !1);
                            ...
                            ((s.simulateTouch && !x.device.ios && !x.device.android) || (s.simulateTouch && !x.support.touch && x.device.ios)) &&
                                (r[t]("mousedown", x.onTouchStart, !1), document[t]("mousemove", x.onTouchMove, n), document[t]("mouseup", x.onTouchEnd, !1));
                        }
                        window[t]("resize", x.onResize),
                            ...
                            x.params.pagination &&
                                ...
                                (x.paginationContainer[a]("click", "." + x.params.bulletClass, x.onClickIndex), x.params.a11y && x.a11y && x.paginationContainer[a]("keydown", "." + x.params.bulletClass, x.a11y.onEnterKey)),
                                ...
                                (i = parseInt(e(x.clickedSlide).attr("data-swiper-slide-index"), 10)),
                                    x.params.centeredSlides
                                        ? o < x.loopedSlides - l / 2 || o > x.slides.length - x.loopedSlides + l / 2
                                            ? (x.fixLoop(),
                                              (o = x.wrapper
                                                  .children("." + x.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.' + x.params.slideDuplicateClass + ")")
                                                  .eq(0)
                                                  .index()),
                                              setTimeout(function () {
                                                  x.slideTo(o);
                ...
                (x.onTouchStart = function (a) {
                        ...
                        if ((a.originalEvent && (a = a.originalEvent), !G || "mousemove" !== a.type)) {
                            ...
                            if (x.params.onlyExternal)
                                return (
                                    ...
                                    void (
                                        b &&
                                        ((x.touches.startX = x.touches.currentX = "touchmove" === a.type ? a.targetTouches[0].pageX : a.pageX),
                            ...
                            if ((S && x.emit("onTouchMove", x, a), !(a.targetTouches && a.targetTouches.length > 1))) {
                                if (((x.touches.currentX = "touchmove" === a.type ? a.targetTouches[0].pageX : a.pageX), (x.touches.currentY = "touchmove" === a.type ? a.targetTouches[0].pageY : a.pageY), void 0 === M)) {
                                    var t;
                                    (x.isHorizontal() && x.touches.currentY === x.touches.startY) || (!x.isHorizontal() && x.touches.currentX === x.touches.startX)
                                        ? (M = !1)
                                        : ((t = (180 * Math.atan2(Math.abs(x.touches.currentY - x.touches.startY), Math.abs(x.touches.currentX - x.touches.startX))) / Math.PI),
                                    ...
                                    if (X) {
                                        ...
                                        if (
                                            (r > 0 && P > x.minTranslate()
                                                ? ((i = !1), x.params.resistance && (P = x.minTranslate() - 1 + Math.pow(-x.minTranslate() + E + r, x.params.resistanceRatio)))
                                                : r < 0 && P < x.maxTranslate() && ((i = !1), x.params.resistance && (P = x.maxTranslate() + 1 - Math.pow(x.maxTranslate() - E - r, x.params.resistanceRatio))),
                                        ...
                                        x.params.followFinger &&
                                            ...
                                            x.params.freeMode &&
                                                (0 === H.length && H.push({ position: x.touches[x.isHorizontal() ? "startX" : "startY"], time: z }),
                                                H.push({ position: x.touches[x.isHorizontal() ? "currentX" : "currentY"], time: new window.Date().getTime() })),
                                            x.updateProgress(P),
                        ...
                        if ((a.originalEvent && (a = a.originalEvent), S && x.emit("onTouchEnd", x, a), (S = !1), b)) {
                                ...
                                (x.allowClick &&
                                    ...
                                    s < 300 &&
                                        ...
                                        (k = setTimeout(function () {
                                            x &&
                                                (x.params.paginationHide && x.paginationContainer.length > 0 && !e(a.target).hasClass(x.params.bulletClass) && x.paginationContainer.toggleClass(x.params.paginationHiddenClass),
                                                x.emit("onClick", x, a));
                                        }, 300))),
                            ...
                            for (f = 0; f < x.slidesGrid.length; f += x.params.slidesPerGroup)
                                void 0 !== x.slidesGrid[f + x.params.slidesPerGroup]
                                    ? r >= x.slidesGrid[f] && r < x.slidesGrid[f + x.params.slidesPerGroup] && ((w = f), (y = x.slidesGrid[f + x.params.slidesPerGroup] - x.slidesGrid[f]))
                                    : r >= x.slidesGrid[f] && ((w = f), (y = x.slidesGrid[x.slidesGrid.length - 1] - x.slidesGrid[x.slidesGrid.length - 2]));
                    ...
                    (x.slideTo = function (e, a, t, s) {
                        ...
                        return (
                            ...
                            (x.rtl && -r === x.translate) || (!x.rtl && r === x.translate)
                                ? (x.params.autoHeight && x.updateAutoHeight(), x.updateClasses(), "slide" !== x.params.effect && x.setWrapperTranslate(r), !1)
                                : (x.updateClasses(),
                    ...
                    (x.fixLoop = function () {
                        ...
                        x.activeIndex < x.loopedSlides
                            ...
                            : (("auto" === x.params.slidesPerView && x.activeIndex >= 2 * x.loopedSlides) || x.activeIndex > x.slides.length - 2 * x.params.slidesPerView) &&
                        ...
                        cube: {
                            setTranslate: function () {
                                ...
                                x.params.cube.shadow &&
                                    (x.isHorizontal()
                                        ? ((a = x.wrapper.find(".swiper-cube-shadow")), 0 === a.length && ((a = e('<div class="swiper-cube-shadow"></div>')), x.wrapper.append(a)), a.css({ height: x.width + "px" }))
                        ...
                        coverflow: {
                            setTranslate: function () {
                                for (
                                    ...
                                    Math.abs(h) < 0.001 && (h = 0), Math.abs(g) < 0.001 && (g = 0), Math.abs(c) < 0.001 && (c = 0), Math.abs(m) < 0.001 && (m = 0), Math.abs(u) < 0.001 && (u = 0);
                        ...
                        setTranslate: function () {
                            if (x.params.scrollbar) {
                                ...
                                (e = (a.trackSize - a.dragSize) * x.progress),
                                    ...
                                    x.isHorizontal()
                                        ? (x.support.transforms3d ? a.drag.transform("translate3d(" + e + "px, 0, 0)") : a.drag.transform("translateX(" + e + "px)"), (a.drag[0].style.width = t + "px"))
                                        : (x.support.transforms3d ? a.drag.transform("translate3d(0px, " + e + "px, 0)") : a.drag.transform("translateY(" + e + "px)"), (a.drag[0].style.height = t + "px")),
                                    x.params.scrollbarHide &&
                    ...
                    (x.zoom = {
                        ...
                        onGestureChange: function (e) {
                            ...
                            a.gesture.image &&
                                ...
                                (x.support.gestures ? (a.scale = e.scale * a.currentScale) : (a.scale = (a.gesture.scaleMove / a.gesture.scaleStart) * a.currentScale),
                                a.scale > a.gesture.zoomMax && (a.scale = a.gesture.zoomMax - 1 + Math.pow(a.scale - a.gesture.zoomMax + 1, 0.5)),
                                a.scale < x.params.zoomMin && (a.scale = x.params.zoomMin + 1 - Math.pow(x.params.zoomMin - a.scale + 1, 0.5)),
                            ...
                            if (a.gesture.image && 0 !== a.gesture.image.length && ((x.allowClick = !1), a.image.isTouched && a.gesture.slide)) {
                                ...
                                if (!(t < a.gesture.slideWidth && s < a.gesture.slideHeight)) {
                                    if (
                                        ...
                                        if (
                                            (x.isHorizontal() && Math.floor(a.image.minX) === Math.floor(a.image.startX) && a.image.touchesCurrent.x < a.image.touchesStart.x) ||
                                            (Math.floor(a.image.maxX) === Math.floor(a.image.startX) && a.image.touchesCurrent.x > a.image.touchesStart.x)
                                        )
                                            return void (a.image.isTouched = !1);
                                        if (
                                            (!x.isHorizontal() && Math.floor(a.image.minY) === Math.floor(a.image.startY) && a.image.touchesCurrent.y < a.image.touchesStart.y) ||
                        ...
                        attachEvents: function (a) {
                            ...
                            if (x.params.zoom) {
                                ...
                                x.support.gestures
                                    ? (x.slides[t]("gesturestart", x.zoom.onGestureStart, s), x.slides[t]("gesturechange", x.zoom.onGestureChange, s), x.slides[t]("gestureend", x.zoom.onGestureEnd, s))
                                    : "touchstart" === x.touchEvents.start &&
                                      (x.slides[t](x.touchEvents.start, x.zoom.onGestureStart, s), x.slides[t](x.touchEvents.move, x.zoom.onGestureChange, s), x.slides[t](x.touchEvents.end, x.zoom.onGestureEnd, s)),
                        ...
                        onEnterKey: function (a) {
                            13 === a.keyCode &&
                                (e(a.target).is(x.params.nextButton)
                                    ? (x.onClickNext(a), x.isEnd ? x.a11y.notify(x.params.lastSlideMessage) : x.a11y.notify(x.params.nextSlideMessage))
                                    : e(a.target).is(x.params.prevButton) && (x.onClickPrev(a), x.isBeginning ? x.a11y.notify(x.params.firstSlideMessage) : x.a11y.notify(x.params.prevSlideMessage)),
                        ...
                        x.params.loop && x.createLoop(),
                            ...
                            x.params.loop
                                ...
                                : (x.slideTo(x.params.initialSlide, 0, x.params.runCallbacksOnInit),
                                  0 === x.params.initialSlide && (x.parallax && x.params.parallax && x.parallax.setTranslate(), x.lazy && x.params.lazyLoading && (x.lazy.load(), (x.lazy.initialImageLoaded = !0)))),
                            x.attachEvents(),
                    ...
                    (x.cleanupStyles = function () {
                        x.container.removeClass(x.classNames.join(" ")).removeAttr("style"),
                            ...
                            x.slides &&
                                x.slides.length &&
                                x.slides
                                    .removeClass([x.params.slideVisibleClass, x.params.slideActiveClass, x.params.slideNextClass, x.params.slidePrevClass].join(" "))
                                    .removeAttr("style")
